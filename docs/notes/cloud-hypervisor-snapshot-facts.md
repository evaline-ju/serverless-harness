...
> _"these platform primitives behave thus in isolation"_, **not** as _"restore works here"_.
...
**Hardware-test pass (2026-09-11).** _Provenance corrected 2026-09-14 after PR review: this
...
something unopenable, this note now states what was exercised, so it is its own record._
...
- **Row 6** (cgroups v1 restore latency): still undocumented, and the
  ...
  _Two restore-latency figures were removed here on 2026-09-14. They cited "§10's informal
  ...
  latency figure for this tier should come from there and nowhere else._
